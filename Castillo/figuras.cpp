...
void CFiguras::skybox(float largo, float altura, float profundidad, GLuint text, GLuint text1)  //Funcion creacion cielo
{
	...
	GLfloat vertice[8][3] = {
		{ 0.5*largo ,-0.5*altura, 0.5*profundidad },    //Coordenadas VÃ©rtice 1 V1
		{ -0.5*largo ,-0.5*altura , 0.5*profundidad },    //Coordenadas VÃ©rtice 2 V2
		{ -0.5*largo ,-0.5*altura , -0.5*profundidad },    //Coordenadas VÃ©rtice 3 V3
		{ 0.5*largo ,-0.5*altura , -0.5*profundidad },    //Coordenadas VÃ©rtice 4 V4
		{ 0.5*largo ,0.5*altura , 0.5*profundidad },    //Coordenadas VÃ©rtice 5 V5
		{ 0.5*largo ,0.5*altura , -0.5*profundidad },    //Coordenadas VÃ©rtice 6 V6
		{ -0.5*largo ,0.5*altura , -0.5*profundidad },    //Coordenadas VÃ©rtice 7 V7
		{ -0.5*largo ,0.5*altura , 0.5*profundidad },    //Coordenadas VÃ©rtice 8 V8
	};
...
void CFiguras::skybox_cielo(float largo, float altura, float profundidad, GLuint text, GLuint piso, GLuint superior, float r)  //Funcion creacion cielo
{
	...
	glTexCoord2f(r, r); glVertex3fv(vertice[7]);
...
void CFiguras::skybox_sin_tapa(float largo, float altura, float profundidad, GLuint text, float r)  //Funcion creacion cielo
{
...
void CFiguras::skybox_casa(float largo, float altura, float profundidad, GLuint text_paredes, GLuint text_piso, GLuint text_puerta, GLuint text_techo, float r, float s , float t, float abrirCasa)  //Funcion creacion cielo
{
	...
	GLfloat vertice[12][3] = {
		...
		{ -0.5*largo ,0.5*altura , -0.5*profundidad },    //Coordenadas Vértice 7 V7
		{ -0.5*largo ,0.5*altura , 0.5*profundidad },    //Coordenadas Vértice 8 V8
		{ 0.33*largo ,0.5*altura , -0.5*profundidad }, //V9
		{ 0.33*largo , 0.0*altura , -0.5*profundidad }, //V10
		{ 0.5*largo , 0.0*altura , -0.5*profundidad }, //V11
		{ 0.33*largo , -0.5*altura , -0.5*profundidad }, //V12
	};

	glBindTexture(GL_TEXTURE_2D, text_paredes);   // choose the texture to use.
	...
	glBegin(GL_POLYGON);	//Back1
							//glColor3f(0.0,1.0,0.0);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, r); glVertex3fv(vertice[6]);
	glTexCoord2f(r, r); glVertex3fv(vertice[8]);
	glTexCoord2f(r, 0.0f); glVertex3fv(vertice[11]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[2]);
	glEnd();

	glBegin(GL_POLYGON);	//Back2
							//glColor3f(0.0,1.0,0.0);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, r); glVertex3fv(vertice[8]);
	glTexCoord2f(r, r); glVertex3fv(vertice[5]);
	glTexCoord2f(r, 0.0f); glVertex3fv(vertice[10]);
	...
	glBindTexture(GL_TEXTURE_2D, text_piso);
	glBegin(GL_POLYGON);//Bottom
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(s, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(s, s); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0f, s); glVertex3fv(vertice[3]);
	glEnd();

	glBindTexture(GL_TEXTURE_2D, text_techo);
	glBegin(GL_POLYGON);  //Top
						  //glColor3f(0.8,0.2,0.4);
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(t, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(t, t); glVertex3fv(vertice[6]);
...
void CFiguras::prisma_tablero(float altura, float largo, float profundidad, GLuint text, float r)  //Funcion creacion prisma
{
...
void CFiguras::cono(float altura, float radio, int resolucion, GLuint text, float r)
{
	...
	for (int i = 0; i <resolucion; i++)
	{
		...
		glTexCoord2f(ctext_s*i, r);	glVertex3f(0.0, altura, 0.0);
		glEnd();
	}
}
